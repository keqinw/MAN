...
class Replay_Memory():
    ...
    # A simple (if not the most efficient) was to implement the memory is as a list of transitions.
        ...
        self.action_I = torch.empty(self.memory_size, action_size, dtype=torch.long)
        self.action_II = torch.empty(self.memory_size, action_size, dtype=torch.long)
    ...
    # Appends transition to the memory.
        ...
        self.action_I[self.idx] = torch.as_tensor(action_I)
        self.action_II[self.idx] = torch.as_tensor(action_II)
