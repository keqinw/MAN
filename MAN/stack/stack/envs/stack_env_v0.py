...
class StackEnv_v0(gym.Env):
    ...
    #     cube_postures = []
    #     for i in range(self.num_cube):
    #         cube_postures.append(self.cube[i].get_posture())
    #     cube_postures = np.array(cube_postures)
        # return cube_postures
